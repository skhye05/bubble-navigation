...
public class BubbleToggleView extends RelativeLayout {
    ...
    public void setBtActive(boolean value) {
        this.isActive = true;
    }

    public void setBtColorActive(int value) {
        bubbleToggleItem.setColorActive(value);
        titleView.setTextColor(bubbleToggleItem.getColorActive());
        setInitialState(isActive);
    }

    public void setBtColorInactive(int value) {
        bubbleToggleItem.setColorInactive(value);
        setInitialState(isActive);
    }

    public void setBtIcon(int icon) {
        bubbleToggleItem.setIcon(ContextCompat.getDrawable(getContext(), icon));
        iconView.setImageDrawable(bubbleToggleItem.getIcon());
    }

    public void setBtIconWidth(float value) {
        bubbleToggleItem.setIconWidth(value);
        LayoutParams lpIcon = new LayoutParams((int) bubbleToggleItem.getIconWidth(), (int) bubbleToggleItem.getIconHeight());
        iconView.setLayoutParams(lpIcon);
    }

    public void setBtIconHeight(float value) {
        bubbleToggleItem.setIconHeight(value);
        LayoutParams lpIcon = new LayoutParams((int) bubbleToggleItem.getIconWidth(), (int) bubbleToggleItem.getIconHeight());
        iconView.setLayoutParams(lpIcon);
    }

    public void setBtTitle(String value) {
        bubbleToggleItem.setTitle(value);
        titleView.setText(bubbleToggleItem.getTitle());
        titleView.measure(0, 0);       //must call measure!
        measuredTitleWidth = titleView.getMeasuredWidth();  //get width
        //limit measured width, based on the max width
    ...
    public void setBtTitleSize(float value) {
        bubbleToggleItem.setTitleSize(value);
        titleView.setTextSize(bubbleToggleItem.getTitleSize());
    }

    public void setBtShape(Drawable value) {
        bubbleToggleItem.setShape(value);
        setInitialState(isActive);
    }

    public void setBtShowShapeAlways(boolean value) {
        showShapeAlways = value;
        setInitialState(isActive);
    }

    public void setBtShapeColor(int color) {
        bubbleToggleItem.setShapeColor(color);
        setInitialState(isActive);
    }

    public void setBtDuration(int value) {
        animationDuration = value;
    }

    public void setBtPadding(int value) {
        bubbleToggleItem.setInternalPadding(value);
        setPadding(
                bubbleToggleItem.getInternalPadding(),
                bubbleToggleItem.getInternalPadding(),
                bubbleToggleItem.getInternalPadding(),
    ...
    public void setBtTitlePadding(int value) {
        bubbleToggleItem.setTitlePadding(value);
        titleView.setPadding(bubbleToggleItem.getTitlePadding(), 0, bubbleToggleItem.getTitlePadding(), 0);
    }

    public void setBtBadgeText(int value) {
    }

    public void setBtBadgeTextSize(float value) {
        bubbleToggleItem.setBadgeTextSize(value);
        updateBadge(getContext());
    }

    public void setBtBadgeTextColor(int value) {
        bubbleToggleItem.setBadgeTextColor(value);
        updateBadge(getContext());
    }

    public void setBtBadgeBackgroundColor(int value) {
        bubbleToggleItem.setBadgeBackgroundColor(value);
        updateBadge(getContext());
    }
